...
function TodayAttendance() {
          ...
          <td className="p-2 whitespace-nowrap">
            {student.attendanceStatus === "late" && (
              ...
              {student.attendanceStatus === "early" && (
                <div className="bg-green-500 h-3 w-9 rounded-sm inline-block mr-1">{student.lastScan
                  ? student.lastScan.toLocaleTimeString([], {
                      hour: "numeric",
                      minute: "2-digit",
                    })
  ...
  {showInfo && (
  <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-90% bg-white border-2 border-black p-5 rounded-lg shadow-lg inline-block">
