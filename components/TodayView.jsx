...
<div className="container py-10 px-10 mx-0 min-w-full flex flex-col items-center">
  <button disabled type="button" className="bg-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 text-gray-900 dark:bg-gray-700 dark:hover:bg-gray-800 dark:focus:ring-gray-500 inline-flex items-center">
    <svg aria-hidden="true" className="inline w-4 h-4 mr-3 text-gray-900 animate-spin" viewBox="0 0 100 101" fill="none" role="status" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                  <div className="flex justify-between items-center mb-4">
                    <div id="search" className="flex items-center w-full">
                      ...
                      <select
                        className="border rounded-r-md py-1  font-bold px-2 text-gray-700 w-1/5 focus:outline-none focus:ring-1 focus:ring-blue-500"
