...
function AttendanceTable() {
  ...
  <div className="w-full rounded-lg mx-auto" style={{ maxWidth: "90%" }}>
    <Switch
      checked={state}
      onChange={setState}
      className={`${state ? "bg-blue-700" : "bg-gray-700"}
    ...
    >
      ...
      />
      <div className="absolute top-1/2 left-[12%] transform -translate-y-1/2 text-white font-bold">
        ATTENDANCE
      </div>
      <div className="absolute top-1/2 right-[18%] transform -translate-y-1/2 text-white font-bold">
        BADGE
      </div>
    </Switch>
  </div>
