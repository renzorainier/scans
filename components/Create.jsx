...
function StudentCollection() {
  const [students, setStudents] = useState([
    ...
    // { id: "01", lrn: "109329100329", name: "MALICDEM, CARLO", section: "1C", strand: "STEM", present: false },
    // { id: "02", lrn: "109351121643", name: "PUREZA, XEDRICK", section: "1C", strand: "STEM", present: false },
    // { id: "03", lrn: "109311100219", name: "ILAO, GIAN RUSSEL", section: "1C", strand: "STEM", present: false },
    // { id: "04", lrn: "425707150124", name: "REGIS, YESTIN GABRIEL", section: "1C", strand: "STEM", present: false },
    ...
    // { id: "44", lrn: "109327100246", name: "BUAL, GABRIEL JOHN", section: "1C", strand: "STEM", present: false },
    // { id: "45", lrn: "109351121673", name: "DAEP, CASSANDRA", section: "1C", strand: "STEM", present: false },
    // { id: "46", lrn: "117873090005", name: "CAMIRING, LEO", section: "1C", strand: "STEM", present: false },
    // { id: "47", lrn: "402941150090", name: "EDANG, CHESKA", section: "1C", strand: "STEM", present: false },
    // { id: "48", lrn: "109309120128", name: "DELA CRUZ, MICHAEL", section: "1C", strand: "STEM", present: false },
    // { id: "49", lrn: "109311100191", name: "GALARION, MIRALYN", section: "1C", strand: "STEM", present: false },
    // { id: "50", lrn: "109351121499", name: "DOMINGO, EZEKIEL", section: "1C", strand: "STEM", present: false },
    // { id: "51", lrn: "109327100789", name: "LOGRONIO, JENNIFER", section: "1C", strand: "STEM", present: false },
    // { id: "52", lrn: "402889150055", name: "GA, JAZPER SID", section: "1C", strand: "STEM", present: false },
    // { id: "53", lrn: "109354100093", name: "MEDALLADA, ANDREA", section: "1C", strand: "STEM", present: false },
    // { id: "54", lrn: "109350090352", name: "GELAGA, MARK AARON", section: "1C", strand: "STEM", present: false },
    // { id: "55", lrn: "109352130003", name: "MERIOLES, KEZEAH", section: "1C", strand: "STEM", present: false },
    // { id: "56", lrn: "109329100333", name: "MALLARI, JHAZREAL", section: "1C", strand: "STEM", present: false },
    // { id: "57", lrn: "109350100604", name: "NALZARO, CHRISTIAN", section: "1C", strand: "STEM", present: false },
    // { id: "58", lrn: "109311100426", name: "VALLECERA, ROEL", section: "1C", strand: "STEM", present: false },
    // { id: "59", lrn: "109336100225", name: "INAS, JUSTIN", section: "1C", strand: "STEM", present: false },
    // { id: "60", lrn: "109352100024", name: "BELDA, CAMILLE SHAINNE", section: "1C", strand: "STEM", present: false },
    // { id: "61", lrn: "109351121626", name: "FURAQUE, REYNALDO JR", section: "1C", strand: "STEM", present: false },
    // { id: "62", lrn: "109328100017", name: "ARBOLEDA, JERICHO", section: "1C", strand: "STEM", present: false },
    // { id: "63", lrn: "109311100063", name: "BATALLER, ADRIAN", section: "1C", strand: "STEM", present: false },
    // { id: "64", lrn: "109329100110", name: "BULATAO, ALEXA", section: "1C", strand: "STEM", present: false },
    // { id: "65", lrn: "136487100093", name: "CALIO, JOHN PAUL", section: "1C", strand: "STEM", present: false },
    // { id: "66", lrn: "109329100178", name: "DAGOOC, SHARMAINE", section: "1C", strand: "STEM", present: false },
    // { id: "67", lrn: "109320120604", name: "CARAGAN, AARON", section: "1C", strand: "STEM", present: false },
    // { id: "68", lrn: "109311100161", name: "ESPONILLA, ALYSSA", section: "1C", strand: "STEM", present: false },
    // { id: "69", lrn: "136890080155", name: "DINDO, JOMAR", section: "1C", strand: "STEM", present: false },
    // { id: "70", lrn: "109339131281", name: "HULLEZA, PRECIOUS", section: "1C", strand: "STEM", present: false },
    // { id: "71", lrn: "109339100469", name: "LOPEZ, ERIN", section: "1C", strand: "STEM", present: false },
    // { id: "72", lrn: "109328100149", name: "LONQUINO, KLAUS", section: "1C", strand: "STEM", present: false },
    // { id: "73", lrn: "109311100271", name: "MENDI, CELINE JOY", section: "1C", strand: "STEM", present: false },
    // { id: "74", lrn: "109343100139", name: "POLINAR, MARJORIE", section: "1C", strand: "STEM", present: false },
    // { id: "75", lrn: "109329100329", name: "MALICDEM, CARLO", section: "1C", strand: "STEM", present: false },
    // { id: "76", lrn: "109351121641", name: "PASAGDAN, RENZ RAINIER", section: "1C", strand: "STEM", present: false },
    // { id: "77", lrn: "109351121636", name: "SAMANIEGO, SEAN", section: "1C", strand: "STEM", present: false },
    // { id: "78", lrn: "109351121643", name: "PUREZA, XEDRICK", section: "1C", strand: "STEM", present: false },
    // { id: "79", lrn: "109311100219", name: "ILAO, GIAN RUSSEL", section: "1C", strand: "STEM", present: false },
    // { id: "80", lrn: "425707150124", name: "REGIS, YESTIN GABRIEL", section: "1C", strand: "STEM", present: false },

    // { id: "04", lrn: "109352100024", name: "BELDA, CAMILLE SHAINNE", section: "1C", strand: "STEM", present: false },

    // { id: "109329100329", name: "MALICDEM, CARLO", section: "ST-1C", strand: "STEM" },
    // { id: "109351121643", name: "PUREZA, XEDRICK", section: "ST-1C", strand: "STEM" },
    // { id: "109311100219", name: "ILAO, GIAN RUSSEL", section: "ST-1C", strand: "STEM" },
    // { id: "425707150124", name: "REGIS, YESTIN GABRIEL", section: "ST-1C", strand: "STEM" }
  ]);
  ...
  // { id: "01", lrn: "402969160037", name: "ALARCON, RHYZEA", section: "ST-1C", strand: "STEM", present: false },
  // { id: "02", lrn: "109339100105", name: "BANTOG, THAMZ JAZLEY", section: "1C", strand: "STEM", present: false },
  // { id: "03", lrn: "114235070063", na  me: "BUCOG, JESSIELYN", section: "1C", strand: "STEM", present: false },
