...
function TeamMember({ name, role, image }) {
  return (
    <div className="flex flex-col pt-6 items-center">
      ...
      <h2 className="font-bold text-lg mt-2 md:text-xl md:mt-4"><span class="bg-gradient-to-r from-blue-400 to-violet-400 text-transparent bg-clip-text">{name}</span> </h2>
