...
function TeamMember({ name, role, image }) {
  return (
    ...
    <div className="w-24 h-24 md:w-32 md:h-32 rounded-full overflow-hidden bg-gradient-to-r from-blue-400 to-violet-400">
      <Image className="object-cover w-full h-full" src={image} alt={name} />
    </div>
    <h2 className="font-bold text-lg mt-2 md:text-xl md:mt-4">
      <span class="bg-gradient-to-r from-blue-400 to-violet-400 text-transparent bg-clip-text">{name}</span>
    </h2>
